...
2. Check that the group access ``r-x`` is for ``sds173``; if not, change the group and reset the access permissions:
...
4. Create a subdirectory called week1. If you want to add more information to the name, you can
